...
// using this reference to open the page in secure https - https://stackoverflow.com/questions/85816/how-can-i-force-users-to-access-my-page-over-https-instead-of-http
//https for secure connection when logging in
if($_SERVER["HTTPS"] != "on")
{
...
if (mysqli_connect_errno($conn)) {
    ...
    <body>
        ...
        <ul>
            <li><a href="home.php">What is Carpool?</a></li>
